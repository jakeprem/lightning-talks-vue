            ...
            <!-- <form> -->
              <div class="field">
                <div class="control">
                  ...
                  <input type="text" class="input is-large" v-model="username" placeholder="Username">
                </div>
              </div>
...
export default {
  ...
  created () {
    ...
    // this.ui.start('#firebase-auth-container', this.uiConfig)
  }
}
</script>
...
<style>
  ...
  .firebaseui-idp-github,.firebaseui-idp-github:hover,.mdl-button.firebaseui-idp-github:active,.mdl-button.firebaseui-idp-github:focus{
  ...
  .firebaseui-idp-twitter,.firebaseui-idp-twitter:hover,.mdl-button.firebaseui-idp-twitter:active,.mdl-button.firebaseui-idp-twitter:focus{
